...
CXXFLAGS = -std=c++17 -I/opt/homebrew/include/SDL2 -I/opt/homebrew/Cellar/sdl2_image/2.8.2_1/include/SDL2 -I/opt/homebrew/Cellar/sdl2_mixer/2.8.0/include/SDL2 -I/opt/homebrew/Cellar/sdl2_ttf/2.22.0/include/SDL2 -D_THREAD_SAFE
...
# Source files
SRC = ./src/ECS/*.cpp ./src/*.cpp ./src/scenes/*.cpp
